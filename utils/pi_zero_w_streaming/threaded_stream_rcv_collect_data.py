...
if __name__ == "__main__":
  ...
  while True:
    ...
    hand_color = "./data/gesture2/color/gesture2_color_"
    hand_gray = "./data/gesture2/gray/gesture2_gray_"
    tail = ".jpeg"
    mid = str(frame)
    name_color = hand_color + mid + tail
    name_gray = hand_gray + mid + tail
    im.save(name_color)
    im.convert('L').save(name_gray)
    frame = frame + 1
